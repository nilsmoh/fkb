...
*/ 
{
                ...
                zeilen: [
                    ...
                    [28.8, "Schwarzenberg Bf.",an,_,    _,    _,   se,    _,    _, 732,    _, 1050,    _, k2b4, sb, sc, 402, sf, 659, sh, k2b4, 911, sk, k2b4, { nr: "100a" }], //fritsche andere schreibung im plan:  "Schwarzenberg"
                    ["Schwarzenberg Bf.",  ab,    _,  435,    _,   se,    _,    _, 739,    _, 1056,    _, 1256, sb, sc, 416, sf,    _, 649, 704, 916, sk, 1125],  //fritsche andere schreibung im plan:  "Schwarzenberg"
