                                    ...
                                    case BLOCK_T.BLOCK:
                                        ...
                                        if (tEintrag.Passend) {
                                            if (tEintrag.Blockinhalt) {
                                                ...
                                                if ((tEintrag.Blockinhalt.Inhalt.BLOCK.Standard as Block2Entry).verlasseKbsNach)
                                                {
                                                ...
                                                if ((tEintrag.Blockinhalt.Inhalt.BLOCK.Standard as Block2Entry).erreicheKbsAus)
                                                {
                                                 ...
                                                 if ((tEintrag.Blockinhalt.Inhalt.BLOCK.Standard as Block2Entry).Fahrtage)
                                                {
