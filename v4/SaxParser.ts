        ...
        public static parse(input: SaxInput.SingleDirectionScheduleInput): SingleDirectionScheduleTyped {
            ...
            if (input.zeilen != null) {
                ...
                for (var i = 0; i < input.zeilen.length; i++) {
                    var zeile: Array<(string | number | SaxInput.IZeilenZusatzInfo)> = input.zeilen[i];
                    if ((zeile != null) && (zeile.length >= 2)) {
                        ...
                        if ((("number" == typeof zeile[0]) ||  //KM Angabe
                            ...
                            (("string" == typeof zeile[0]) && ((<string>zeile[0]).indexOf(SaxInput._anschluss_aus) == 0)) ||
                            (("string" == typeof zeile[0]) && ((<string>zeile[0]).indexOf(SaxInput._anschluss_aus_ziel) == 0)) ||
                            (("string" == typeof zeile[0]) && ((<string>zeile[0]).indexOf(SaxInput._anschluss_nach_start) == 0)) ||
                            (("string" == typeof zeile[0]) && ((<string>zeile[0]).indexOf(SaxInput._anschluss_nach_in) == 0))) {
                                        ...
                                        if (rawEntry.indexOf("_") == 0) {
                                            ...
                                            // hier ANK, waagerechte linie, 
                                                ...
                                                var tResultEntryB: TBlockEintrag = {
                                                    ...
                                                    Hoehe: 1,
                                                    Passend: true, // Gegenteil waere fern
                                                    Referenzkey: (rawEntry.indexOf(SaxInput.SENKRECHT_PREFIX) == 0) ? rawEntry.substr(senkleng) : rawEntry.substr(waagleng),  // while invalid markers are letters
                                                ...
                                                */
                                                ...
                                                /*
                                                var tBlock: TBlockInhaltZugnummerOderKlasse = ZI_Creator.createTBlockInhaltZugnummerOderKlasse(null, rawEntry);
                                                ...
                                                */
                                                ...
                                                if (rawEntry.indexOf(SaxInput.k2b3) == 0) {kl = Kl2bis3}
                                                if (rawEntry.indexOf(SaxInput.k2b4) == 0) {kl = Kl2bis4}
                                                if (rawEntry.indexOf(SaxInput.k3b4) == 0) {kl = Kl3bis4}
                        ...
                        if (("string" == typeof zeile[0]) && (((<string>zeile[0]).indexOf(SaxInput._zugnr) == 0)
                            ...
                            if (((<string>zeile[0]).indexOf(SaxInput._klassen) == 0) || (<string>zeile[1]).indexOf(SaxInput.kl) == 0) {
                                ...
                                if (("string" == typeof zeile[0])
                                    && ((<string>zeile[1]).indexOf(SaxInput.kl) == 0)
                                    && ((<string>zeile[0]).indexOf(SaxInput.WAAGERECHT_PREFIX) == 0)) {
                            ...
                            for (var zi = 2; zi < zeile.length; zi++) {
                                if ("number" == typeof zeile[zi]) {
                                    ...
                                    */
                                    ...
                                    ((<string>zeile[zi]).indexOf(SaxInput.k1b3) == 0)
                                    || ((<string>zeile[zi]).indexOf(SaxInput.k2b3) == 0)
                                    || ((<string>zeile[zi]).indexOf(SaxInput.k2b4) == 0)
                                    || ((<string>zeile[zi]).indexOf(SaxInput.k3b4) == 0))) {
                                    ...
                                    */
                                    ...
                                    if ((<string>zeile[zi]).indexOf(SaxInput.k2b3) == 0){kl = Kl2bis3}
                                    if ((<string>zeile[zi]).indexOf(SaxInput.k2b4) == 0){kl = Kl2bis4}
                                    if ((<string>zeile[zi]).indexOf(SaxInput.k3b4) == 0){kl = Kl3bis4}
                                    ...
                                    ((<string>zeile[zi]).indexOf(SaxInput.SENKRECHT_PREFIX) == 0)
                                    || ((<string>zeile[zi]).indexOf(SaxInput.WAAGERECHT_PREFIX) == 0)
                                    ...
                                    var tResultEntryB: TBlockEintrag = {
                                        ...
                                        Hoehe: 1,
                                        Passend: true, // Gegenteil waere fern
                                        Referenzkey: ((<string>zeile[zi]).indexOf(SaxInput.SENKRECHT_PREFIX) == 0) ? (<string>zeile[zi]).substr(senkleng) : (<string>zeile[zi]).substr(waagleng),  // while invalid markers are letters
                                        Blockinhalt: undefined,
                                        BerechneterZugLauf: { kind: ZUGLAUF_UNBEKANNT }
                                    };
                                ...
                                else if (("string" == typeof zeile[zi]) && (zeile[zi] != null) && (("string" == typeof zeile[0]) && (((<string>zeile[0]).indexOf(SaxInput._zugnr) == 0)))) {
                                    //zugnr z.b. 1234a
    ...
    public static parseKlassenString(Klassenstring: string | null | undefined): EKlassen {
        ...
        if (Klassenstring != undefined) {
            switch (Klassenstring) {
                case SaxInput.k1b3: tKlassen = EKlassen.Klassen1bis3;
                    break;
                case SaxInput.k2b3: tKlassen = EKlassen.Klassen2bis3;
                    break;
                case SaxInput.k2b4: tKlassen = EKlassen.Klassen2bis4;
                    break;
                case SaxInput.k3b4: tKlassen = EKlassen.Klassen3bis4;
                    break;
