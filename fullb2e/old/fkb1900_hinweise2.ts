...
type Block2Entry = {
    ...
    haeltAuchIn?:string,
    AnschlussZubringerAb?:{ZugNr?:string,SubBhf?:string, Bhf?:string, Zeit?:string | number, Klasse?:string,  WeitereFernStartpunkte?:Array<string>, Geltungstag?:string, 
        mitUmstiegIn?:string, mitUmstiegInZugNr?:string,  ohneUmstieg?:boolean, Ueber?:string[]},    // anschluss abfahrt fuer zelle jetzt mit konkretem zeilentyp !!! 
...
var x39:Array<page>=[{
    ...
    list:[{
        ...
        BLOCK:{Standard:{scope:virtuellerAnschlussAus, virtuellerAnschluss:{ AnschlussAusZeit:705, AnschlussAusBhf: "Magdeburg"}}}
    },{
...
var x48: Array<page> =[{head:"48",
    list:[{
        ...
        BLOCK:{Standard: {}, Abweichend:{scope:Zelle, GeltungsTag:vom15junbis15sept, AnschlussZubringerAb:{Zeit:335}}}
    },{
...
list:[{
    ...
    q:"bis Erf. 229",
    BLOCK:{Standard:{scope:AnschlussZug, AnschlussWeiterNach:{Bhf:"Erfurt", Zeit:"MV229"}}}
},
// KBS25 Radebeul
{
...
list:[{
    ...
    BLOCK:{Standard:{scope:AnschlussZug, AnschlussZubringerAb:{Bhf:"Erfurt", Zeit:"HV229"}}}
},{
    q:"von Mailand Stuttgart",
    BLOCK:{Standard:{scope: AnschlussZug ,  AnschlussZubringerAb:{WeitereFernStartpunkte:["Mailand","Stuttgart"]}}}
},{
...
list:[{
    ...
    BLOCK:{Standard:{scope:AnschlussZug,  AnschlussWeiterNach:{Bhf:"Časlau"}}}
},
// Radeburg kbs25
{
...
BLOCK:{Standard: {}, Abweichend:{scope:Zelle,  GeltungsTag:vom15junbis15sept, AnschlussZubringerAb:{Bhf:"Breslau", Zeit:"335"}}}
},{
    q:"Nur Sonnabends",
...
//Zugsverbindungen  //so eine art staedtevrbindungstabelle
{
    ...
    BLOCK:{Standard:null, Abweichend:{scope:Zelle, AnschlussZubringerAb:{Zeit:"705"}}}
},{
...
list:[{
    ...
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Falkenstein", Klasse: Kl2bis3}}
},{
    q:"+ab Falkenstein auch IV. Kl.",
     BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Falkenstein", Klasse: Kl2bis4}}
},{
    q:"Alle Zuege II. III.Kl.",
    BLOCK:{Standard:{scope:Global, Klasse:Kl2bis3}}
}]}];
...
list:[{
    ...
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Wittgensdorf", TZgueltigBisBhf:"Chemnitz", ZugNr:"1654", Klasse:Kl1bis4}}
...
list:[{
    ...
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Chemnitz", TZgueltigBisBhf:"Wittgensdorf", ZugNr:"1730", Kategorie:"Schnellzug", Klasse:Kl1bis3}}
},{
    q:"Alle Zuege II - IV Kl", //global
    BLOCK:{Standard:{scope:Global, Klasse:Kl2bis4}}
}]}];
...
// TODO Fussuebergang in eigener Zeile
    q:"+Sonn und festtags",
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Grossbothen", TZgueltigBisBhf:"Rochlitz", Fahrtage:SonnUndFesttags}}
}]}]; 
...
list:[
{
    ...
    BLOCK:{Standard:{scope:Zug, Fahrtage: Werktags}, Abweichend:{scope:TeilZug,  TZgueltigAbBhf:"Annaberg", TZgueltigBisBhf:"Erdmansdorf", Fahrtage:Montags}}
},{
    q:"Sonn und festtags", //passend
    BLOCK:{Standard:{scope:Zug, Fahrtage: SonnUndFesttags}}
},{
...
list:[
{
    ...
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Chemnitz", TZgueltigBisBhf:"Floeha", ZugNr:"1009", Klasse:Kl1bis4}}
},{
    q:"Saechs. Staatsb.", //global
    BLOCK:{Standard:{scope:Tabelle, Verwaltung:"Saechs"}}
},{
...
list:[{
    ...
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Zwoenitz", Klasse: Kl2bis3}}
},{
    q:"II-IV Kl", //global
    BLOCK:{Standard:{scope:Global, Klasse:Kl2bis4}}
}
...
BLOCK:{Standard:{scope:TeilZug, TZgueltigAbBhf:"Schlettau", TZgueltigBisBhf:"Annaberg",  ZugNr: 1996}}
}
    ]}];
