interface Block2{
    Standard:Block2Entry ,
    Abweichend?:Block2Entry ,
...
type Block2Entry = {
    ...
    Fortsetzung?: boolean,
    scope?: string | {kind:"ZugZellenFolge", startZelle:string, endZelle: string} | ZeilenFolge | ZubringerZellenFolge | ZugFuerExpliziteNrn,
    RedundanteZugNr?: Array<String | Number>,
    AnschlussZeit?: String | Number,
    AnschlussAusZeit?: string | number,
    AnschlussAusBhf?: string,
    AnschlussAusBhfSub?: string, //schles bhf fuer DD Neust
    ...
    AnschlussZubringerAb?:{ZugNr?:string,Bhf?:string, Zeit?:string | number, Klasse?:string,  WeitereFernStartpunkte?:Array<string>, Geltungstag?:string, mitUmstiegIn?:string,  ohneUmstieg?:boolean, Ueber?:string[]},    // anschluss abfahrt fuer zelle jetzt mit konkretem zeilentyp !!! 
    ...
    ZugOhneSpalte?:{Fahrtage:string, Klasse:string, ZugNr:string, weg:[{bhfAb?:string, zeit:number | string, bhfAn?:string}]}
...
var Global = "";
var TeilZug = "";
var AnschlussZug= ""; //mehrzeilig
var ZubringerZug=""; //mehrzeilig
var ZuegeInBelegtenSpalten = ""; //waagerecht "Sonn und Festtagszuege" in  wa,wa,wa,wa,wa --> diese 5 zuege betroffen
var Zelle = ""; //scope
var virtuellerAnschlussAus = ""; //scope   , AnschlussAusZeit:705, AnschlussAusBf: "Magdeburg"}}  --> virtuelle zeile einbauen ?
var Zeile = ""; //scope z.b. haelt in Ulbersdorf nur zum Aussteigen
var Tabelle = ""; //scope
...
var vom15junbis15sept = "";
//var Vom25VIbis31VIII = "";
...
var x24: Array<page> = [
    {
        ...
        [{ q: "a. Dresden Hptbf. Nordh.     1207" ,
            ...
            BLOCK: {  Standard: {  Fehler: "alternativer bahnhof not implemented" }, Abweichend: {} }
        },
        {
        ...
        },
        {
            ...
            BLOCK: { Standard: { OhneNrNach: ["Arnsdorf"] }, Abweichend: {} }
        },

        {
            q: "nach Bautzen",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Bautzen"] }, Abweichend: {} }
        },
        {
            q: "nach Bischofswerda",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Bischofswerda"] }, Abweichend: {} }
        },
        {
            q: "nach Coswig",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: {OhneNrNach: ["Coswig"] }, Abweichend: {} }
        },
        {
            q: "nach Döbeln-Leipzig",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Döbeln", "Leipzig"] }, Abweichend: {} }
        },
        {
            q: "nach Elsterwerda-Berlin",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Elsterwerda", "Berlin"] }, Abweichend: {} }
        },
        {
            q: "nach Görlitz",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: {OhneNrNach: ["Görlitz"] }, Abweichend: {} }
        },
        {
            q: "nach Meissen-Cölln",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Meissen-Cölln"] }, Abweichend: {} }
        },
        {
            q: "Sonn- und Festtags nach Meissen-Cölln",
            c: "nicht tägl !",
            BLOCK: { Standard: { OhneNrNach: ["Meissen-Cölln"], Fahrtage: SonnUndFesttags }, Abweichend: {} }
        },
        {
            q: "nach Nossen",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Nossen"] }, Abweichend: {} }
        },
        {
            q: "nach Radeberg",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Radeberg"] }, Abweichend: {} }
        },
        {
            q: "nach Reichenberg",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Reichenberg"] }, Abweichend: {} }
        },

        {
            q: "nach Riesa",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Riesa"] }, Abweichend: {} }
        },
        {
            q: "nach Riesa-Leipzig",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Riesa", "Leipzig"] }, Abweichend: {} }
        },
        {
            q: "nach Röderau-Berlin",
            c: "//direkt_daneben_passend_senkrecht_weiter_nach_ohne_streckennummer",
            BLOCK: { Standard: { OhneNrNach: ["Röderau", "Berlin"] }, Abweichend: {} }
        },

        {
            ...
            BLOCK: { Standard: { OhneNrNach: ["Döbeln"], Fahrtage: SonnUndFesttags }, Abweichend: {} }
        },
        {
            q: "nach Coswig",
            ...
            BLOCK: { Standard: {OhneNrNach: "COSWIG"}, Abweichend: {Fahrtage: SonnUndFesttags, OhneNrNach: "Meissen-Coelln"} }
        },
        {
            q: "Fortsetzung",
            c: "Tabellenteil untereinander statt logisch nebeneinander",
            BLOCK:{Standard:{scope:Tabellenteil, Fortsetzung:true}, Abweichend:{}}
        }
        ]
    }
];
...
//25.1
var x25_1:Array<page> = [{
    head:"Seite25 Tabelle 1 Rueckrichtung",
    list: [{
        q: "von Arnsdorf",
        BLOCK: {Standard: { OhneNrAus: ["Arnsdorf"]}, Abweichend: {}} 
    },
    {   q:"von Berlin-Elsterwerda",   
        BLOCK: {Standard: { OhneNrAus: ["Berlin","Elsterwerda"]}, Abweichend: {}} 
    },
    {   q:"von Berlin-Röderau" ,
        BLOCK: {Standard: { OhneNrAus: ["Berlin","Röderau"]}, Abweichend: {}} 
    },
    {   q:"von Bischofwerda",
        BLOCK: {Standard: { OhneNrAus: ["Bischofswerda"]}, Abweichend: {}} 
    },
    {   q:"von Bautzen",
        BLOCK: {Standard: { OhneNrAus: ["Bautzen"]}, Abweichend: {}} 
    },
    {   q:"von Coswig",
        BLOCK: {Standard: { OhneNrAus: ["Coswig"]}, Abweichend: {}} 
    },
    {   q:"von Görlitz",
        BLOCK: {Standard: { OhneNrAus: ["Görlitz"]}, Abweichend: {}} 
    },
    {   q:"von Leipzig-Döbeln",
        BLOCK: {Standard: { OhneNrAus: ["Leipzig","Döbeln"]}, Abweichend: {}} 
    },
    {   q:"von Leipzig-Riesa",
        BLOCK: {Standard: { OhneNrAus: ["Leipzig","Riesa"]}, Abweichend: {}} 
    },
    {   q:"von Meissen-Cölln",
        BLOCK: {Standard: { OhneNrAus: ["Meissen-Cölln"]}, Abweichend: {}} 
    },
    {   q:"von Radeberg",   
        BLOCK: {Standard: { OhneNrAus: ["Radeberg"]}, Abweichend: {}} 
    },
    {   q:"von Reichenberg",
        BLOCK: {Standard: { OhneNrAus: ["Reichenberg"]}, Abweichend: {}} 
    },
    {   q:"von Riesa",
        BLOCK: {Standard: { OhneNrAus: ["Riesa"]}, Abweichend: {}} 
    },
    {   q:"Sonn- und Festtags von Döbeln //direkt daneben passend senkrecht faehrt nur sonn und festtags, doebeln getrennt anzugebn",
        BLOCK: { Standard: { OhneNrAus: ["Döbeln"], Fahrtage: SonnUndFesttags }, Abweichend: {}}
    },
    {   q:"Sonn- und Festtags von Meissen-Cölln",
        BLOCK: {scope: Zug, Standard: {scope:Zug, OhneNrAus: ["Meissen-Cölln"], Fahrtage: SonnUndFesttags }, Abweichend: {}}
    }
    ]
}];
/*
--------------------------------------------------------------------------------------------------------------------------------------------------
*/
var x26_2_3: Array<page> = [
    {head: "26.2, 26.3",
     list:[{
            q: "*Verkehrt Werktags vor Sonn- und Festtagen bis Edle Krone (Ank. 504) und Klingenberg (Ank. 523)",
            c: "  //  (ganzer zug verkehrt weiter)",
            BLOCK: {Standard: [], Abweichend:[{scope: Zug, Fahrtag: SonnUndFesttags, ohneNrNach : [{ziel: "edlekrone", ank: 504},{ziel: "Klingenberg", ank:523}]}]
        }},
        {
            q:"+Sonn und festtags",
           ...
           {q:"*Nur Sonnabends.", 
            ...
            BLOCK: {Standard:{Fahrtage: Sonnabends}, Abweichend: {}}
           },
           {q:"+Nur an Werktagen,ausser Sonnabends.",
            c:" //(ganzer zug verkehrt) /",
            BLOCK: {Standard:{ Fahrtage: WerktageAusserSonnabends}, Abweichend: {} },
           },
           {q: "n. Königsbrück" ,
            c: "verlaesst strecke",
            BLOCK : {Standard:{OhneNrNach: "Koenigsbrueck"}, Abweichend: {}}
        },
        {
            q: "nach Schwepnitz",
            BLOCK:{ Standard:{OhneNrNach: "Schwepnitz"}, Abweichend: {}}
        }
...
var x27_2_3: Array<page> =[
{   head: "27.2",
    list:[{
        q: "Nur Werktags",
        BLOCK: { Standard:{Fahrtage: Werktags}}
    },
    {   q: "Sonn und Festtags",
        BLOCK: { Standard:{Fahrtage: SonnUndFesttags}}
    },
    {
        q: "*Verkehrt in der auf Sonn- oder Festtag folgenden Nacht", 
        c: " (ganzer zug verkehrt)",
        BLOCK: {Standard:{Fahrtage: InDerAufEinenSonnOderFesttagFolgendenNacht}}
    },
...
//27.3
    ...
    {   q:"von Königsbrück",
        BLOCK: {Standard:{OhneNrAus:"Königsbrück"}}
    },
    {   q:"nur werktags und zwar montags oder, wenn der fesstag dienstags von königsbrück, sonst aus moritzdorf", 
        ...
        BLOCK: {Standard:{Fahrtage: Werktags, OhneNrAus: "Moritzdorf"}, Abweichend:{Fahrtage: MontagsFallsMontagEinFesttagDannDienstag, OhneNrAus: "Koenigsbrueck"}}
    },
    {   q:"von Schwepnitz",
        BLOCK: {Standard:{OhneNrAus:"Schwepnitz"}}
    },
    {   q: "+Züge 708, 714 und 720 verkehren nur sonn und festtags",
        c:"//ohne zugnr angabe waere logisch identisch",
        BLOCK:{Standard:{Fahrtage:SonnUndFesttags, RedundanteZugNr:[708,714,720]}}
    }  
]}];
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
},
{
    ...
    BLOCK: {Standard:{}, Abweichend:{scope:Zelle, GeltungsTag:SonnUndFesttags, AnschlussZeit:  HN1105}}  //HeuteNachmittag
},
{
q: "Nur sonn und festtags",
...
},
{
    ...
    q: "Sonn- u. Festt.",
    BLOCK: {Standard:{scope:Zelle, GeltungsTag:SonnUndFesttags, AnschlussZeit:HN305}, Abweichend:{}}  //in standard da sonst leer
},{
...
},
{
    ...
    BLOCK:{Standard:{scope:Zelle, AbfahrtsOrt:"glashuette", AbfahrtsZeit:600}, Abweichend:{GeltungsTag: SonnUndFesttags, AbfahrtsOrt:"geising-a", AbfahrtsZeit:500 }}
}
]}];
...
var x30: Array<page> = [{
    ...
    list:[{
        ...
        {q:"nach Berlin",
         BLOCK : {Standard:{OhneNrNach: "Berlin"}}
        },{
        q:"nach Leipzig",
        BLOCK : {Standard:{OhneNrNach: "Leipzig"}}
    },
    {   q:"nach Riesa",
        BLOCK : {Standard:{OhneNrNach: "Riesa"}}
    },
    {
    ...
    {   q:"+zug 1556 verkehrt von coswig bis meissen-c nur sonn und festtags", 
        ...
        BLOCK: {Standard: {scope: {kind: "ZugZellenFolge", startZelle: "coswig",  endZelle: "Meissen-Coelln"} ,  
                GeltungsTag: SonnUndFesttags, RedundanteZugNr: [1556]} }   //sonst: leer
    },
...
list:[
    {
        ...
        q:"von Berlin",
        BLOCK: { Standard: { OhneNrAus: ["Berlin"]}}
    },{
        q:"von Riesa",
          BLOCK: { Standard: { OhneNrAus: ["Riesa"]}}
    },{
        q:"von Leipzig",
        BLOCK: { Standard: { OhneNrAus: ["Leipzig"]}}
    },{
...
var x32_7hin: Array<page> = [{
    head: "32.7 Leipzig->Wurzen",
    list: [{
        q: "nur mittwoch und sonnabend bis liebertwolkwitz",
        c: "//nicht taeglich laut rahmen",
        BLOCK: { Standard: { Fahrtage: MittwochsUndSonnabends, OhneNrNach: ":Liebertwolkwitz" } }
    }, {
        q: "nach Geithain",
        BLOCK: { Standard: { OhneNrNach: ["Geithain"] } }
    }, {
        q: "nach Doebeln",
        BLOCK: { Standard: { OhneNrNach: ["Doebeln"] } }
    }, {
        q: "nach Grossbothen",
        BLOCK: { Standard: { OhneNrNach: ["Grossbothen"] } }
    }, {
        q: "nach Belgershain",
        BLOCK: { Standard: { OhneNrNach: ["Belgershain"] } }
    }, {
        q: "nach Grimma",
        BLOCK: { Standard: { OhneNrNach: ["Grimma"] } }
    }, {
        q: "nach Liebertwolkwitz",
        BLOCK: { Standard: { OhneNrNach: ["Liebertwolkwitz"] } }
    }, {
        q: "nur werktags",
        BLOCK: { Standard: { Fahrtage: Werktags } }
    }, {
...
var x32_7b: Array<page> = [{
head:"/32.7 rueckrichtung",
list:[
    {q:"Nur Werktags",
    BLOCK:{Standard:{Fahrtage:Werktags}}
    },{ q:"von Otterwisch",
        BLOCK:{Standard:{OhneNrAus:"Otterwisch"}}
    },{ 
        q:"von nossen",
        BLOCK:{Standard:{OhneNrAus:"Nossen"}}
    },{
        q:"von Geithain",
        BLOCK:{Standard:{OhneNrAus:"Geithain"}}
    },{
        q:"von Doebeln",
        BLOCK:{Standard:{OhneNrAus:"Doebeln"}}
    },{
        q:"von Belgershain",
        BLOCK:{Standard:{OhneNrAus:"Belgershain"}}
    },{
        q:"von Grimma",
        BLOCK:{Standard:{OhneNrAus:"Grimma"}}
    },{
        q:"von Liebertwolkwitz",
        BLOCK:{Standard:{OhneNrAus:"Liebertwolkwitz"}}
    },{
        q:"von grossbothen",
        BLOCK:{Standard:{OhneNrAus:"Grossbothen"}}
    },
    {   q:"in der nacht v. mittw zum donnerst und v sonnabend zu sonntag von liebertwolkw", 
        ...
        BLOCK:{Standard:{Fahrtage: InDerNachtVonMittwochZuDonnerstagUndSonnabendZuSonntag, OhneNrAus: "Liebertwolkwitz"}}
}]}];



var x33_8: Array<page> = [{
    head: "33",
    list: [{
        q: "nach Meuselwitz",
        BLOCK: { Standard: { OhneNrNach: "Meuselwitz" } }
    }, {
        q: "nach Zwenkau",
        BLOCK: { Standard: { OhneNrNach: "Zwenkau" } }
    }, {
        q: "nach Groitzsch",
        BLOCK: { Standard: { OhneNrNach: "Groitzsch" } }
    }, {
        q: "Sonn und Festtags",
        BLOCK: { Standard: { Fahrtage: SonnUndFesttags } }
        ...
        q: "von Zwenkau",
        BLOCK: { Standard: { OhneNrAus: "Zwenkau" } }
    }, {
        q: "von Meuselwitz",
        BLOCK: { Standard: { OhneNrAus: "Meuselwitz" } }
    }, {
        q: "von Groitzsch",
        BLOCK: { Standard: { OhneNrAus: "Groitzsch" } }
    }, {
        q: "Sonn und festtags",
        BLOCK: { Standard: { Fahrtage: SonnUndFesttags } }
    }
...
var x34:Array<page> = [{
    ...
    list:[{ 
        ...
        BLOCK:{Standard:{Fahrtage:WerktageVorSonnUndFesttagen}}
    },{
    q:"von Limbach",
    BLOCK:{Standard:{OhneNrAus:"Limbach"}}
},{
    q:"Sonnund festtags",
    BLOCK:{Standard:{Fahrtage:SonnUndFesttags}}
},{
    ...
    q:"nach Limbach",
    BLOCK:{Standard:{OhneNrNach:"Limbach"}}
},{
    q:"nur werktags",
    BLOCK:{Standard:{Fahrtage:Werktags}}
    ...
    q:"pfeilstart",
    BLOCK:{Standard:{PfeilStart:true}}
},{
    q:"pfeilziel",
    BLOCK:{Standard:{PfeilZiel :true}}
},{
    q:"nur sonn und festtags",
    BLOCK:{Standard:{Fahrtage:SonnUndFesttags}}
},{
...
BLOCK:{Standard:{Fahrtage:SonnUndFesttags}}
//ab chemnitz fahrkarte

},{q:"nur werktags",
BLOCK:{Standard:{Fahrtage:Werktags}}
},{q:"Nur Werktags mit ausnahme der sonnabende und des 23.mai",
BLOCK:{Standard:{Fahrtage: WerktagsMitAusnahmeDerSonnabendeUndDes23Mai}}
...
var x39:Array<page>=[{
    ...
    list:[{
        ...
        BLOCK:{Standard:{scope:virtuellerAnschlussAus, AnschlussAusZeit:705, AnschlussAusBhf: "Magdeburg"}}
    },{
...
var x42:Array<page> =[{
    ...
    list:[{
        ...
        BLOCK:{Standard:{}, Abweichend:{scope:Zelle, GeltungsTag:SonnUndFesttags, AnschlussAusZeit:918}}
    },{
    ...
    list:[{
        ...
        BLOCK:{Standard:{scope:Global, AllgemeineInfo: AllgemeineInfo.FahrpreiseSeite222}}
           ...
           BLOCK:{Standard:{scope:Global, AllgemeineInfo: AllgemeineInfo.DresdnerVerbindungsbahnzuegseSieheUnter1 }}
            ...
            BLOCK:{Standard:{scope:Zelle, AnschlussAusBhfSub: "Schles.Bf"}}
        },{
...
var x48: Array<page> =[{head:"48",
    list:[{
             //auch über röder giltig  fuer FK gehoert in zeilenzusatzinfo
        q:"*von 15juni bis15sept:335",
        BLOCK:{Standard:{}, Abweichend:{scope:Zelle, GeltungsTag:vom15junbis15sept, AnschlussAusZeit:335}}
    },{
...
list:[{
    ...
    BLOCK:{Standard:{scope:Zug, OmnibusUeberfuehrung:["DrednerBhf","ThueringerBhf"]}}
},{
    q:"bis Erf. 229",
    BLOCK:{Standard:{AnschlussWeiterNach:{Bhf:"Erfurt", Zeit:"MV229"}}}
},
// KBS25 Radebeul
{
...
list:[{
    ...
    BLOCK:{Standard:{AnschlussZubringerAb:{Bhf:"Erfurt", Zeit:"HV229"}}}
},{
    q:"von Mailand Stuttgart",
    BLOCK:{Standard:{AnschlussZubringerAb:{WeitereFernStartpunkte:["Mailand","Stuttgart"]}}}
},{
...
list:[{
    ...
    BLOCK:{Standard:{AnschlussWeiterNach:{Bhf:"Časlau"}}}
},
// Radeburg kbs25
{
...
BLOCK:{Standard:{}, Abweichend:{GeltungsTag:vom15junbis15sept, AnschlussZubringerAb:{Bhf:"Breslau", Zeit:"335"}}}
},{
    q:"Nur Sonnabends",
...
list:[{
    q:"*Sonn und festtags 831",
    BLOCK:{Standard:{},Abweichend:{AnschlussWeiterNach:{Geltungstag:SonnUndFesttags, Zeit:"831"}}}
   },{
...
list:[{ q:"*In Oberullersdorf halten die Zuege nur zum Einsteigen", // wie eXXXX an allen zeiten
    BLOCK:{Standard:{scope:Zeile, ZuegeHaltenNurZumEinsteigen:true}}
},{
    q:"Nur werktags",
    BLOCK:{Standard:{scope:Zug, Fahrtage:Werktags}}
},{
...
,{
    ...
    BLOCK:{Standard:{scope:Zeile, ZuegeHaltenNurZumAussteigen:true}}
},{
...
var x60:Array<page> =[{
    ...
    list:[
  {
    ...
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Cunewalde", Fahrtage:SonnabendsSonnUndFesttags, RedundanteZugNr:["807"]}}        //gueltigAbBhf muss von validierer gegen bahnhof geprüft werden
},
{
    q:"+Zug 807 und 808 verkehren zwischen Cunewalde und Bautzen nur Sonnabends, Sonn- und Festtags", //sonst kuerzer naemlich nur Obercunewalde - cunewalde !!!
    c:"808 bis koeblitz nur manchmal",
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigBisBhf:"Koeblitz", Fahrtage:SonnabendsSonnUndFesttags, RedundanteZugNr:["808"]}}        //gueltigAbBhf muss von validierer gegen bahnhof geprüft werden
},{
...
list:[{
    ...
    BLOCK:{Standard:{}, Abweichend:{GeltungsTag:Vom15JuniBis15September, AnschlussZubringerAb:{Zeit:"s335"}}}
},{
    ...
    //{kind:"ZeilenFolge", startZeileBhf:string, endZeileBhf: string}
    BLOCK:{Standard:{scope:{kind:"ZeilenFolge", startZeileBhf:"Goerlitz", endZeileBhf: "Nikrisch"}, Verwaltung:"KED Breslau"}, 
...
list:[{
    ...
    c:"",
    BLOCK:{Standard:{scope:{kind:"ZubringerZellenFolge", startZelle:"Seidenberg", endZelle: "Nikrisch"}, AnschlussZubringerAb:{ ZugNr:"624"} , AnschlussZubringerIn:{ZugNr:"624"}  }}
},{
    q:"anschluss aus zugnr 628",
    c:"",
    BLOCK:{Standard:{scope:{kind:"ZubringerZellenFolge", startZelle:"Seidenberg", endZelle: "Nikrisch"}, AnschlussZubringerAb:{ ZugNr:"628"} , AnschlussZubringerIn:{ZugNr:"628"}  }}
}
]}];
...
// reko zugnummern ergeben sich aus Malteserkreuz -> sind plausibel
    ...
    BLOCK:{Standard:{scope:TeilZug, TZgueltigAbBhf:"Bertsdorf" ,  TZgueltigBisBhf:"Oybin", Fahrtage:SonnUndFesttags20MaiBisEndeAugust, RedundanteZugNr:[2639]}}
...
,{
    ...
    BLOCK:{Standard:{scope:Zug, Fahrtage:Werktags}, 
        Abweichend:{scope:TeilZug, TZgueltigAbBhf:"KoenigsbrueckB" ,  TZgueltigBisBhf:"Moritzdorf", Fahrtage:MontagsFallsMontagEinFesttagDannDienstag, RedundanteZugNr:[2744]}}
}]},
{head:"63.46 kpl",
list:[{
    q:"Alle Zuege II - III Kl",
...
list:[{
    ...
    q:"*von Meerane",
    BLOCK:{Standard:{erreicheKbsAus:"Meerane"}}
},{
    q:"+von Meerane",
    BLOCK:{Standard:{erreicheKbsAus:"Meerane"}}
}]}]; 
...
list:[{
    ...
    q:"D I.II.",
    BLOCK:{Standard:{scope:TeilZug, TZgueltigAbBhf:"Reichenbach" ,  TZgueltigBisBhf:"Hof", Kategorie: "DZug", Klasse: Kl1bis2 }}
},{
    q:"!Nord Süd Express",
...
list:[{
   ...
   BLOCK:{Standard:{scope:Global, AllgemeineInfo:AllgemeineInfo.DirecteWagenSUnter247}}
    ...
    q:"!Nord-Süd-Express",
    BLOCK:{Standard:{scope:TeilZug, TZgueltigAbBhf:"Hof" ,  TZgueltigBisBhf:"Reichenbach", AnschlussWeiterNach:{Kategorie:"Nord Sued Express"}}}
},{
    q:"D I.II. ", // D steht vor Zugnummer: D101 siehe unten
    BLOCK:{Standard:{scope:TeilZug, TZgueltigAbBhf:"Hof" ,  TZgueltigBisBhf:"Reichenbach", Kategorie: "DZug", Klasse: Kl1bis2 }}
},{
    q:"nach Gössnitz",
...
list:[{
    ...
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf: "Glauchau"  ,ZugNr:1057}}
},{ 
...
list:[{
    ...
    q:"nach Eger(Ank329)",
    BLOCK:{Standard:{verlasseKbsNach: {nach:["Eger"] , AnkunftsZeit:"329"}}}
},{
    q:"I-IV Kl", //ZugZellenfolge oder teilzug
    BLOCK:{Standard:{scope:TeilZug, TZgueltigAbBhf:"Plauen i V" , TZgueltigBisBhf:"Hof", Klasse:Kl1bis4 }}
},{
    q:"b.Weiden",
    c:"anschlusszug verlauf ",
    BLOCK:{Standard:{scope:AnschlussZug, mehrZeiligerAnschlusszugFaehrtNach:"Weiden" }}
},{
    ...
    q:"nach Eger (Ank533)",
    BLOCK:{Standard:{verlasseKbsNach: {nach: ["Eger"] , AnkunftsZeit:"SMV533"}}}
},{
    q:"!über Schnabelwald",
    c:"detail eines Anschlusszuges mit mehreren Zeilen",
    BLOCK:{Standard:{scope:AnschlussZug, AnschlussWeiterNach:{Ueber:["Schnabelwald"]}}}
},{
   //71.57
    q:"Saechs Staatsb",
    BLOCK:{Standard:{scope:Global, Verwaltung:"Saechs"}}
...
list:[{
    ...
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Reichenbach"  ,ZugNr:233}}    
},{
    q:"+ab Werdau Nr. 205",  //zugnr angabe
    BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Werdau"  ,ZugNr:205}}    
},{
    q:"von Eger",
    ...
    BLOCK:{Standard:{scope: ZubringerZug, mehrzeiligerAnschlusszugKommtAus:"Zwickau"}}
},{
...
,{
    ...
    q:"b coeth",
    BLOCK:{Standard:{scope: AnschlussZug, mehrZeiligerAnschlusszugFaehrtNach: "Coethen"}}
},{
...
list:[{
    ...
    BLOCK:{Standard:{scope:TeilZug,   TZgueltigAbBhf:"Gaschwitz", TZgueltigBisBhf: "Leipzig Bay Bf",  ZugNr:247, Klasse:Kl2bis4}}   
}]}];
...
list:[{
    ...
    q:"! ueb Mrkt Redwitz",
    BLOCK:{Standard:{scope:ZubringerZug , AnschlussZubringerAb:{Ueber:["Mrkt Redwitz"]}}}
},{
    q:"+I.Kl. u. nur von 15.6. bis 15.9.", //anschluss_zubringer_ab und anschluss_zubringer_hin",
    BLOCK:{Standard:{scope:ZubringerZug, Fahrtage: vom15junbis15sept, Klasse: Kl1}}
},{
    ...
    q:"*I-IV Kl ", //fern fuer startmarker bis endmarker",
     BLOCK:{Standard:{scope:TeilZug,   TZgueltigAbBhf:"Adorf", TZgueltigBisBhf: "Reichenbach",  Klasse: Kl1bis4}}
},{
    ...
    BLOCK:{Standard:{scope:TeilZug,   TZgueltigAbBhf:"PlauenOB", TZgueltigBisBhf: "Reichenbach",  ZugNr:211, Klasse:Kl1bis4}}   
},{
...
list:[{
    ...
    q:"*D I II",
    BLOCK:{Standard:{scope:ZubringerZug,  Kategorie: "DZug", Klasse: Kl1bis2 }}
},{
    ...
    BLOCK:{Standard:{scope:TeilZug,   TZgueltigAbBhf:"Adorf", TZgueltigBisBhf: "Eger",  Klasse: Kl1bis3}}
},{
    q:"s.u.56",
    ...
    BLOCK:{Standard:{scope:AnschlussZug ,AnschlussWeiterAb:"Franzensbad" }}
},{
    q:"!ueber Marktredwitz",
    BLOCK:{Standard:{scope:AnschlussZug, AnschlussWeiterNach:{Ueber:["Marktredwitz"]} }}
},{
    q:"(rechteck) I.Kl u  nur von 15juni b 15 sept",
    BLOCK:{Standard:{scope:AnschlussZug, Fahrtage: vom15junbis15sept, Klasse: Kl1}}
},{
    q:"+ I.Kl u nur von 16.V. b 16.IX",
    BLOCK:{Standard:{scope:AnschlussZug, Fahrtage: vom16maibis16sept, Klasse: Kl1}}
},{
    q:"(geschweifte klammer) von 15.6 b. 15.8",
    c:"Anschluss weiter regensburg muenchen",
    BLOCK:{Standard:{scope:AnschlussZug, Fahrtage: vom15junibis15august  } }
},{
...
76
Saechs. Staatsb. //oben links global default
Sonn und festtags
Sonn und festtags sowie mittwochs
!Saechs Bhf //anschluss_zubringer_aus Gera (Pr) geaendert su Gera (Sä)
!Gera (Reuss) Saechs. Bhf. //anschluss_weiter_in geaendert
* in Altenburg //anschluss_weiter_in
Sonn und festtags
mehrere eintraege in einer Spalte f. Anschluss_weiter_in
Nur Werktags
Ausserdem zusaetzliche tabelle


77
Saechs. Staatsb.  //global
Dir Wag S 247 //global
Sonn - und festtags //passend in zugspalte
Sonn- und festtags sowie am 5.juni (Pfingstdienstag) //passend in zugspalte
i. Bad Elster //anschluss_weiter_in Bahnhofsaenderung
78
Dir. Wagen s. 247
Nur Werktags //passend in zugspalte
Sonn- und Festtags.
Ausserdem: Zug 2046a (II.-IV. Kl.): ab Meerane 330, in Goessnitz 341  //waere eigene spalte wenn der platz reichte
Ausserdem: Zug 2045a (II.-IV. Kl.): ab Goessnitz 354, in Meerane 405  //waere eigene spalte wenn der platz reichte
79
Saechs. Staatsb. //global oben links
+Sonn und Festtags: 1139



80
Saechs. Staatsb. //global oben links
Alle Zuege fuehren nur e i n e Wagenklasse. //global, halbe leerzeichen in eine
Ausserdem: an Sonn- und Festtagen: 820 von Reichenbach i.V. unt.Bhf nach Mylau Haltest
Ausserdem: an Sonn- und Festtagen: 800 von  Mylau Haltest nach Reichenbach i.V. unt.Bhf 
Ausserdem: an Werktagen: 715 von Mylau Bhf nach Reichenbach i.V. unt.Bhf
In der Nacht nach Sonn- u. Festtagen
Sonn- und Festtags. //passend, aber rechts neben den zeiteintraegen
81
Saechs. Staatsb. //global keine globalen klassen
*ab Falkenstein nur II. u. III. Kl.
+ab Falkenstein auch IV. Kl.
Alle Zuege II. III.Kl.
82
Saechs. Staatsb. //global
+Nur Werktags
ueb Lausigk in Leipzig Ank 1024//kursiv
ub Lausigk in Leipzig Ank 925//kursiv
Sonn und Festtags
(rund) Bei den mit(rund) bezeichneten Zuegen findet in Leipzig Omnibusueberfuehrung vom Bayer. nach dem Magdeb. Bahnhof zu den Anschlusszuegen statt
Alle Zuege II - IV Kl //global
*Ab Wittgensdorf bis Chemnitz Zug 1654 I-IV Kl
83
Saechs. Staatsb. //global
Nur Werktags
Von Leipzig (840 Abf) ueber Lausigk
Von Leipzig (635 Abf) ueber Lausigk
+Zug 1640 haelt auch in Oetzsch
(rund) Bei den mit(rund) bezeichneten Zuegen findet in Leipzig Omnibusueberfuehrung vom Magdeb. nach dem Bayer Bahnhof zu den Anschlusszuegen statt
*Zug 1730 ist von Chemnitz bis Wittgensdorf Schnellzug I.-III.Kl.
Alle Zuege II - IV Kl //global
84
Saechs. Staatsb. //global
*Sonn- und Festtags
...
85 (KBS75..)
Nur Mittwochs und Sonnabends
In der Nacht v. Mittwoch z. Donnerstag und vom Sonnabend z. Sonntag.
(Kieritsch Kroitzsch Pegau erst 1909 eroeffnet[sic])
86
Alle Zuege II u III Klasse
(Chemnitz Obergruena eroeffnet 1903 nur Gueter?)
87
Saechs. Staatsb.
Alle Zuege II u III Kl
88 (kbs81)
Nur Sonn- und Festtags
Nur Werktags
Dir Wag S 247
*II u III Kl
Alle Zuege II u III Kl
...
Nur Werktags
Nur Sonn und Festtags
Saechs Staatsbahn //global
AlleZuege II u III Kl //global
...
Saechs. Staatsb. //global
Sonn und festtags
Rueckfahrk. Leipz-Grimma ueb Wurzen oder Naunhof //global
Umwegkarten Wurzen-Borsdorf-Grossbothen und umgek. zu Fahrk. nach Grossboth. etc. ueb. Nerchau// global
Fussuebergang
Sonn und festtags
91
Saechs Staatsb.
Sonn- und Festtags
Nur am 1. Mittw. jed. Mon., demnach i.d. Nacht v.2/3mai, 6/7 juni, 4/5 juli, 1/2 aug. u 5/6 Sept
Fussuebergang
+Sonn und festtags
92 
(Wechselburg-chemnitz erst 1902 eroeffnet)
93
Saechs staatsb //global
II-IV Kl //global
Nur Sonn- und Festtags mit IIuIII Kl //nicht taegl, Iv kl in sachsen eh nicht am sonn+festtag (erst 1908)
+Zug 5584 haelt Sonn u Festtags auch in Roedlitz
94 (KBS85f)
Saechs. Staatsb. //global
Sonn und festtags //passend
Sonn und festtags im juni, juli und august //passend
+Zug 1394 faehrt im Mai und September taeglich, in der uebrigen Zeit nur werktags
S.Stb. //global
II u III Kl //global
++nur Sonn und festtags //wa in zugnummernzeile! nicht klassenzeile, 
95 (fkb85-88)
Saechs Stsb
(rund) von Annaberg bis Erdmansdorf nur montags, von Erdmansdorf bis chemnitz an allen werktagen
Sonn und festtags //passend
Sonn und festtags im juni, juli und august
+ Zug 1395 verkehrt im Mai und septembertaeglich, in der uebrigen Zeit nur Werktags.
Saechs stsb //global
Alle Zuege II III Kl //global
96
Saechs Staatsb.
**Von chemnitz bis Floeha Zug 1009 mit I-IV Kl
Saechs Staatsb. //global
II bis IV Kl //global
97 
Saechs Staatsb //global
Sonn und Festtags //passend
+Mit Umsteigen in floeha unter Benutzung der Zuege 1069/107 (s.Nr.11 u 54)
!Umsteigen in Floeha in Zug1018 (s.Nr.54)  //Anschluss_zubringer_aus, der aber intern ein umsteigen fordert wenn man aus dresden kommt
SaechsStaatsb //global
II u III Kl //global
98 (FKB94f)
Saechs staatsb //global
Nur Sonn- und Festtags //passend
Nur Werktags //passend
Nur am Werkktage vor Sonn- und Festtag. //passend
Saechs. Staatsb. //global
II-IV Kl //global
99 (FKB94f rueck)
Saechs.Staatsb. //global
...
Nur Sonn- und Festtags
101 (FKB98)
s.a.94 //geschweifte Klammer in header
**II.-IV.Kl. //geschweifte Klammer
*Werktags //zeit f anschluss nach in

*/


// ab hier schon gedruckt
var x102_99: Array<page> = [
    {head: "102 (FKB99)",
    list: [
{q:"Saechs Staatsb", //global   
 BLOCK:{Standard:{Verwaltung:"saechs"}}
},{q:"nach Stollberg", //verlasse KBS
BLOCK:{Standard:{ verlasseKbsNach : "Stollberg"}}
},{q:"(rund) Zug 1961" ,
...
BLOCK:{Standard:{scope:TeilZug,   TZgueltigAbBhf:"Zwickau"  ,ZugNr:2064, Klasse: Kl2bis4}}                       //gueltigAbBhf muss von validierer gegen bahnhof geprüft werden
},{
q:"!Ab Zwickau Zug 2054 II.-IV.",
BLOCK:{Standard:{scope: TeilZug, TZgueltigAbBhf:"Zwickau"  ,ZugNr:2054, Klasse: Kl2bis4}}                        //gueltigAbBhf muss von validierer gegen bahnhof geprüft werden
},{
q:"(rund) Ab Zwickau Zug 2060 II.-IV.",
BLOCK:{Standard:{scope:TeilZug,  TZgueltigAbBhf:"Zwickau"  ,ZugNr:2060, Klasse:Kl2bis4}}        //gueltigAbBhf muss von validierer gegen bahnhof geprüft werden
},{
q:"von Stollberg", //aus anderer KBS
BLOCK:{Standard:{erreicheKbsAus:"Stollberg"}}
},{
q:"**Zug 1996", //geschweifte klammer
BLOCK:{Standard:{ZugNr: 1996}}
}
    ]}];
...
var x105: Array<page> = [{
    ...
    BLOCK:{Standard:{}, Abweichend:{GeltungsTag: SonnUndFesttags, AbfahrtsZeit:HN830}} //zubringer aus schlettau faehrt dort sonntags 830
},
{   q: "Alle Zuege II u III Kl",
    BLOCK:{Standard:{scope:Global, Klasse: Kl2bis3}}
},
{   q:"+Direkter Wagen zwischen Werdau und Karlsbad",
    BLOCK:{Standard:{scope:"??", DirekterWagen:["werdau","karlsbad"]}}
}
]}];
