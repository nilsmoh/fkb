...
var Global = { kind: "Global" }; //Scope
var Tabelle = { kind: "Tabelle" }; //scope
var Zelle = { kind: "Zelle" }; //scope z.b. haelt in Ulbersdorf nur zum Aussteigen
var Zug = { kind: "Zug" }; //""; //scope
    ...
    input.forEach(function (p) {
        p.list.forEach(function (ent) {
            ["Standard", "Abweichend", "Alternative"].forEach(function (saa) {
                if (ent.BLOCK[saa]) {
                    if (ent.BLOCK[saa].scope !== undefined) {
                        var b = ent.BLOCK[saa];
